...
export default function Layout({ children, onSearch }: { children: React.ReactNode, onSearch: () => void }) {
              ...
              <form className="w-3/5 mx-auto">
                ...
                <div className="relative w-full">
                  ...
                  <button
                    ...
                    onClick={onSearch} // Panggil fungsi refresh yang diterima dari props                  
                  >
                    Search
                  </button>
                </div>
